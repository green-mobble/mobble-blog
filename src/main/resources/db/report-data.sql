...
(12, 9, 'ADVERTISING_BOARD_CONTENT', NULL, '불법 광고가 포함되어 있습니다.', 'PROCESSING', NOW()),
...
(4, 3, 'PERSONAL_INFORMATION', NULL, '전화번호가 노출되어 있습니다.', 'PROCESSING', NOW()),
...
(15, 2, 'ETC', '허위 정보', '사실과 다른 허위 정보가 있습니다.', 'PROCESSING', NOW()),
...
(19, 8, 'PERSONAL_INFORMATION', NULL, '주소가 노출되어 있습니다.', 'PROCESSING', NOW()),
