...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const deleteBackdrop = deleteModal?.querySelector(".post-modal__backdrop");
    const confirmBtn = document.getElementById("confirmDeleteBtn");
    const openBtn = document.getElementById("openDeleteModal");

    if (!deleteModal || !openBtn) return;
    ...
    // 닫기 (취소 버튼, 배경 클릭)
    deleteModal.querySelectorAll("[data-close='true']").forEach((btn) =>
    ...
    confirmBtn?.addEventListener("click", () => {
        const url = openBtn.dataset.deleteUrl;
